...
class ExtractTextFromImagesUseCase @Inject constructor(
    ...
    operator fun invoke(apiKey: String, images: List<Bitmap>, languageCode: String): Flow<ResultWrapper<String>> {
        val prompt = """
        ...
        """.trimIndent()
        return visionRepository.generateContent(apiKey, prompt, images, emptyList())
    }
}
